...
public class UpdateTeacherActivity extends AppCompatActivity {
   ...
   //task update teacher and delete
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_teacher);
        // we have to option to get data we can get it from firebase or we can get it from updatefaculty using intent passing
        //now get data
        ...
        uploadTask.addOnCompleteListener(UpdateTeacherActivity.this,new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull  Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(UpdateTeacherActivity.this, "Somethig went wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
