...
public class UploadImage extends AppCompatActivity {
   ...
   private String category;  //storing category which select by user
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bitmap==null){
                 ...
                 //checking user has enter category or not
    ...
    private void uploadData() {
        ...
        reference.child(uniqKey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
